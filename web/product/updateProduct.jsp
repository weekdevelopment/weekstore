                    ...
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="file" name="imgsrc2" id="imgsrc2" placeholder="상품 서브이미지" class="form-control">
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="file" name="imgsrc3" id="imgsrc3" placeholder="상품 서브이미지2" class="form-control">
                            </td>
                        </tr>
                        </tbody>
                    </table>
